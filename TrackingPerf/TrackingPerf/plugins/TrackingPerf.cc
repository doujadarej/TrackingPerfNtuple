...
void TrackingPerf::clearVariables() {
 //-----------------------
  //fill the tree per track
   ...
   tree_gsftrack_pt.clear() ;
   tree_gsftrack_outerPt.clear();
   tree_gsftrack_eta.clear();
   tree_gsftrack_phi.clear();
   tree_gsftrack_nhits.clear();
   tree_gsftrack_simtrack_pt.clear();
   tree_gsftrack_simtrack_outerPt.clear();
   tree_gsftrack_simtrack_eta.clear();
   tree_gsftrack_simtrack_phi.clear();
   tree_gsftrack_simtrack_nhits.clear();
